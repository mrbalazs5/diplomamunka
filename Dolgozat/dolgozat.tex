...
\bibitem{enigma} Military Enigma machine, model "Enigma I"  \url{https://en.wikipedia.org/wiki/Enigma_machine#/media/File:Enigma_(crittografia)_-_Museo_scienza_e_tecnologia_Milano.jpg}

\bibitem{shrdlu} SHRDLU https://hci.stanford.edu/~winograd/shrdlu/
